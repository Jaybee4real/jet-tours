      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.linkList}>
              <li><Link href="#tours">Safari Tours</Link></li>
              <li><Link href="#transfers">Airport Transfers</Link></li>
              <li><Link href="#custom">Custom Packages</Link></li>
              <li><Link href="#group">Group Tours</Link></li>
            </ul>
          </div>
